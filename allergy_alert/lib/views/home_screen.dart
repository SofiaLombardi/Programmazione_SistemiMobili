...
class _HomeScreenState extends State<HomeScreen> {
                            ...
                            children: [
                              ...
                              vm.forecastPollen.isEmpty
                                  ...
                                  : SizedBox(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemCount: vm.forecastPollen.length,
                                        itemBuilder: (context, index) {
                                          final item = vm.forecastPollen[index];
                                          final average =
                                              (item.birchPollen +
                                                  item.grassPollen +
                                                  item.olivePollen) /
                              ...
                              vm.symptomHistory.isEmpty
                                  ...
                                  : ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        final log = vm.symptomHistory[index];
                                        return Card(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => LogSymptomScreen(viewModel: vm),
                ),
              );
            },
            backgroundColor: Colors.teal,
  ...
  Widget _buildPollenRow(String label, double value) {
    Color statusColor = _getPollenColor(value);
    return Card(
